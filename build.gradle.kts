...
val excludePackages: List<String> by extra {
    listOf(
        "com/kaiqkt/magiapi/Application*",
        "com/kaiqkt/magiapi/application/config/*",
        "com/kaiqkt/magiapi/application/web/requests/*",
        "com/kaiqkt/magiapi/application/web/responses/*",
        "com/kaiqkt/magiapi/domain/models/*",
        "com/kaiqkt/magiapi/domain/dtos/*",
        "com/kaiqkt/magiapi/domain/utils/*",
    )
}
